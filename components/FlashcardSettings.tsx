...
export default function FlashcardSettings({
  ...
  return (
    <div 
      ref={menuRef}
      className={`fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white border border-black/10 rounded-lg shadow-lg z-50 w-[80%] max-w-sm overflow-visible ${
